...
反馈 Bug, 提出建议或者想法；任何帮助改进，可以加入交流群：![alt text](https://img.shields.io/badge/QQ_Groups-418103279-brightgreen)
...
| <kbd>Tab</kbd>                                               | 选择检测的子窗口矩形的深度                        | Local  |
| <kbd>`</kbd> / <kbd>~</kbd>                                  | 显示或隐藏 当前窗口的信息(Path/Size/PID/HWnd ...) | Local  |
| <kbd>Ctrl</kbd> + <kbd>Shift</kbd> + <kbd>S</kbd>            | 快捷键快速保存到到指定的路径                      | Local  |
...
xmulitech@gmail.com | https://sunny.xmuli.tech
